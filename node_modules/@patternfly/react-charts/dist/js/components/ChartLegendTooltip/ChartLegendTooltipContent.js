...
const ChartLegendTooltipContent = (_a) => {
    var { activePoints, center, datum, dx = 0, dy = 0, flyoutHeight, flyoutWidth, height, labelComponent = React.createElement(ChartLegendTooltipLabel_1.ChartLegendTooltipLabel, null), legendComponent = React.createElement(ChartLegend_1.ChartLegend, null), legendData, patternScale, text, themeColor, title, titleComponent = React.createElement(ChartLabel_1.ChartLabel, null), width, 
    // destructure last
    ...
    const getLegendComponent = () => React.cloneElement(legendComponent, Object.assign({ data: (0, chart_tooltip_1.getLegendTooltipVisibleData)({
            activePoints,
            colorScale: legendProps.colorScale,
            legendData,
            patternScale,
