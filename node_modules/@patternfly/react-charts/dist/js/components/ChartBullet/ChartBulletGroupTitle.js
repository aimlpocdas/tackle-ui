...
const ChartBulletGroupTitle = ({ ariaDesc, ariaTitle, capHeight = 1.1, dividerComponent = React.createElement(victory_core_1.Line, null), name, padding, standalone = true, subTitle, themeColor, title, titleComponent = React.createElement(ChartLabel_1.ChartLabel, null), 
// destructure last
