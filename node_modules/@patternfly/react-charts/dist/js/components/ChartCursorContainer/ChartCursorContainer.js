...
const ChartCursorContainer = (_a) => {
    ...
    // destructure last
    theme = (0, chart_theme_1.getTheme)(themeColor), cursorLabelComponent = React.createElement(ChartLabel_1.ChartLabel, null) } = _a, // Note that Victory provides its own label component here
    rest = tslib_1.__rest(_a, ["className", "cursorComponent", "themeColor", "theme", "cursorLabelComponent"]);
