 ...
 * @private
 */
export declare const renderChildrenWithPatterns: ({ children, patternScale }: PatternPropsInterface) => (string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode>)[];
export {};
